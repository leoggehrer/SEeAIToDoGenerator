//@CodeCopy
#if ACCOUNT_ON
using SEeAIToDoGenerator.Logic.Entities.Account;
using SEeAIToDoGenerator.Logic.Modules.Exceptions;
using SEeAIToDoGenerator.Logic.Modules.Security;
using System.Text;

namespace SEeAIToDoGenerator.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEeAIToDoGenerator.Common.Modules.ThreadSafe;
